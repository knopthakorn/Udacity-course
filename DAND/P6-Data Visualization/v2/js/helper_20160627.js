...
var optionSelect = {
                      0 : [dimensions[0], dimensions[4], dimensions[8]],
                      ...
                      5 : [dimensions[0], dimensions[4], dimensions[12], dimensions[13],  dimensions[14]],
                      6 : [dimensions[0], dimensions[4], dimensions[9], dimensions[12], dimensions[13], dimensions[14], dimensions[15], dimensions[16], dimensions[17], dimensions[18]],
                      7 : [dimensions[0], dimensions[4], dimensions[10], dimensions[12], dimensions[13], dimensions[14], dimensions[15], dimensions[16], dimensions[17], dimensions[18]],
                      8 : [dimensions[0], dimensions[4], dimensions[11], dimensions[12], dimensions[13], dimensions[14], dimensions[15], dimensions[16], dimensions[17], dimensions[18]]
}
...
function updateChart(n) {
    ...
    function drawLegend ()
    {
        ...
        svg.append("g")
           ...
           //.attr("transform", "translate(" + (xAlign) + "," + 650 + ")");
        ...
        svg.append("g")
           ...
           //.attr("transform", "translate(" + xAlign + "," + 630 + ")")
           .text('Continent');
    }
}
